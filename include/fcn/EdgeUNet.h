...
struct EdgeUNetImpl : torch::nn::Module {
    ...
    Down down1{nullptr}, down2{nullptr}, down3{nullptr};
    Up up1{nullptr}, up2{nullptr}, up3{nullptr};
    ...
    torch::Tensor forward(const torch::Tensor& x) {
        ...
        auto u1 = up1->forward(x4, x3);
        auto u2 = up2->forward(u1, x2);
        auto u3 = up3->forward(u2, x1);

        return outc->forward(u3);
    }
};
